...
\begin{figure}[H]
  \centering
    ...
    \fbox{\includegraphics[width=0.5\textwidth]{bilder/dam_break}}
  \caption{Partiklar som får en acceleration från vägg.}
\end{figure}
...
\begin{figure}[H]
  \centering
    \setlength\fboxsep{0pt}
    \setlength\fboxrule{0.5pt}
    \fbox{\includegraphics[width=0.5\textwidth]{bilder/koolwave}}
  \caption{Partiklar som får en acceleration från vägg.}
\end{figure}
...
\begin{figure}[H]
  \centering
    \setlength\fboxsep{0pt}
    \setlength\fboxrule{0.5pt}
    \fbox{\includegraphics[width=0.5\textwidth]{bilder/emiters}}
  \caption{Partiklar som får en acceleration från vägg.}
\end{figure}
