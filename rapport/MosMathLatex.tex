...
Trycket kan bestämmas med den ideala gaslagen:
\begin{equation}
{\it pV = nRT}
\end{equation}
...
För att få en jämnare kraftfördelning som mer följer Newtons tredje lag används följande summering.
...
En reflektionsvinkel beräknas mellan partiklarna och hastigheten uppdateras i den riktningen.
